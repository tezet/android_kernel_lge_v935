...
#ifdef CONFIG_MACH_MSM8974_T1LTE_GLOBAL_COM
// Resreved Pin
...
static int gpio_reserved_pin_rev_a[] = {
	12, 13, 14, 23, 24, 29, 41, 42, 45, 46, 51, 52, 53, 54, 55, 56, 59, 62, 67, 69,
	74, 75, 77, 78, 79, 81, 82, 85, 86, 90, 91, 92, 102, 129, 130, 131, 132, 135, 137,
	MSM8974_GPIO_END // This is included to notify the end of reserved GPIO configuration.
};
...
#endif /* CONFIG_MACH_MSM8974_T1LTE_GLOBAL_COM */
...
#ifndef CONFIG_MACH_MSM8974_T1LTE_GLOBAL_COM
...
static struct msm_gpiomux_config msm_blsp_configs_rev_a[] __initdata = {
	...
	{
		.gpio	   = 25,		/* BLSP5_1 CAPSENS0_I2C_SDA */
		.settings = {
	...
	{
		.gpio	   = 26,		/* BLSP5_0 CAPSENS0_I2C_SCL */
		.settings = {
...
#else /* !CONFIG_MACH_MSM8974_T1LTE_GLOBAL_COM */
...
#if 1  /* 0 : Cap Sensor disable 1 : Cap Sensor enable */
...
if( lge_get_board_revno() >= HW_REV_A ){
	...
	printk(KERN_ERR " <atmf04> AdSemicon Cap Sensor IC for HW_REV : %d \n",lge_get_board_revno());
}
else{
	printk(KERN_ERR " <atmf04> AdSemicon Cap Sensor IC not supported for HW_REV : %d \n",lge_get_board_revno());
}
#endif
