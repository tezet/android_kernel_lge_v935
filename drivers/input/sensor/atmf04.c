...
#define ATMF04_CRCS_DUTY_LOW        650
#define ATMF04_CRCS_DUTY_HIGH       1300
...
const unsigned char InitCodeVal2[CNT_INITCODE] = { 0x00, 0x0D, 0x33, 0x0C, 0x08, 0x71, 0x6D, 0x04, 0x00, 0x0C, 0x08, 0x01, 0x20 }; // Low Band  ANT
#else
